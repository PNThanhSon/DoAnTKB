...
CREATE TABLE GIAOVIEN (
    ...
    CONSTRAINT FK_GIAOVIEN_TOCHUYENMON FOREIGN KEY (MaTCM) REFERENCES TOCHUYENMON(MaTCM)
);
...
GRANT SELECT ON TKB.HOCKY TO TKB;
GRANT INSERT ON TKB.HOCKY TO TKB;
GRANT UPDATE ON TKB.HOCKY TO TKB;
GRANT DELETE ON TKB.HOCKY TO TKB;
...
--Sau khi chạy xong hết thì commit
COMMIT;
